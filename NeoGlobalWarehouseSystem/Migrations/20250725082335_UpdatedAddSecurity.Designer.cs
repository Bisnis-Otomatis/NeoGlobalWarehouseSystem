...
namespace NeoGlobalWarehouseSystem.Migrations
{
    ...
    [Migration("20250725082335_UpdatedAddSecurity")]
    partial class UpdatedAddSecurity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NeoGlobalWarehouseSystem.Data.ApplicationDb.ProductInputLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NeoGlobalWarehouseSystem.Data.ApplicationDb.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("NeoGlobalWarehouseSystem.Data.ApplicationDb.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NeoGlobalWarehouseSystem.Data.ApplicationDb.ProductInputLog", b =>
                {
                    b.HasOne("NeoGlobalWarehouseSystem.Data.ApplicationDb.Product", "Product")
                        .WithMany("ProductInputLog")
            ...
            modelBuilder.Entity("NeoGlobalWarehouseSystem.Data.ApplicationDb.TransactionProduct", b =>
                {
                    ...
                    b.HasOne("NeoGlobalWarehouseSystem.Data.ApplicationDb.Transaction", "Transaction")
                        .WithMany("TransactionProducts")
